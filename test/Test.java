...
public class Test {
	...
	public static void main(String[] args) throws ACRException {
		...
		/**
		 * 
		 * recognize by file path of (Formatter: Audio/Video) Audio: mp3, wav,
		 * m4a, flac, aac, amr, ape, ogg ... Video: mp4, mkv, wmv, flv, ts, avi
		 * ...
		 * 
		 * 
		 **/
		// It will skip 0 seconds.
		Result result = re.recognizeByFile(args[0], 0);
		System.out.println(result.getStatus());

		/**
		 * 
		 * recognize by buffer of (Formatter: Audio/Video) Audio: mp3, wav, m4a,
		 * flac, aac, amr, ape, ogg ... Video: mp4, mkv, wmv, flv, ts, avi ...
		 * 
		 * 
		 **/
